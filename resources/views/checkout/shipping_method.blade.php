        ...
        <div class="col-md-7 col-sm-7 col-xs-7">
          <div class="bread-crumb">
            <ul>
              ...
              <li>\</li>
              <li><a href="{{url('/cart/shipping_method')}}">Shipping</a></li>
            </ul>
          </div>
        </div>
      </div>
            ...
            <div class="row">
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="checkout-stap">
                  <div class="title"> <span class="stap">1 </span><a href="{{url('/cart/checkout')}}">Billing &amp; Shipping Address</a></div>
                </div>
              </div>
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="checkout-stap active">
                  <div class="title"><span class="stap">2 </span><a href="{{url('/cart/checkout/shipping_method')}}">Shipping Method</a></div>
                </div>
              </div>
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="checkout-stap ">
                  <div class="title"><span class="stap">3 </span><a href="{{url('/cart/checkout/payment')}}">Payment Method</a></div>
                </div>
              </div>
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="checkout-stap">
                  <div class="title"><span class="stap">4 </span><a href="{{url('/cart/checkout/order')}}">Order</a></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-xs-12 col-sm-12">
          ...
          <div class="cart-bottom">
            <div class="box-footer">
              <div class="pull-left"><a href="{{url('cart/checkout')}}" class="btn btn-default"> <i class="fa fa-arrow-left"></i> &nbsp; Shipping address </a></div>
              <div class="pull-right"><a class="btn btn-primary btn-small " href="{{url('cart/checkout/payment')}}"> Payment Method&nbsp; <i class="fa fa-arrow-circle-right"></i> </a></div>
            </div>
          </div>
        </div>
      </div>
