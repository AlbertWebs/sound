        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                        {{-- <h1> Edit Brands </h1> --}}
                        <center><h2> Edit Brands </h2></center>
                    </div>
                </div>
                  <hr />
                 <!--BLOCK SECTION -->
              ...
              <div class="row">
               <center>
				...
				@endif
                 ...
                 <form class="form-horizontal" method="post"  action="{{url('/admin/edit_Brand')}}/{{$Client->id}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="text1" name="name" value="{{$Client->name}}" placeholder="e.g JVC " class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Meta Description</label>

                        <div class="col-lg-8">
                            <textarea id="limiter" name="meta" class="form-control">{{$Client->meta}}</textarea>
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="{{url('/')}}/uploads/brands/{{$Client->image}}" alt="" /></div>
