    ...
    (function () {
        ...
        (Riode.$window = $(window)),
                        ...
                        (a.$wrapper = e),
                            ...
                            (function (e) {
                                (e.$selects = e.$wrapper.find(".product-variations select")),
                                    ...
                                    (e.$btnCart = e.$wrapper.find(".btn-carts")),
                                    e.variationCheck(),
                            ...
                            (function (e) {
                                e.$wrapper.on("click", ".btn-carts", function (t) {
                                    t.preventDefault();
                                    var i = e.$wrapper,
                            ...
                            (function (e) {
                                e.$wrapper.on("click", ".btn-compare", function (t) {
                                    ...
                                    var i = e.$wrapper,
                                        n = i.find(".product-name").text();
                                    (i.closest(".product-popup").length || document.body.classList.contains("home")) & ("disabled" != i.find(".btn-product.btn-carts").attr("disabled")) &&
                                        Riode.Minipopup.open({
                                            message: "Successfully Added",
            ...
            (Riode.initProductSinglePage = (function () {
                ...
                function t(e) {
                    var t = $(e.currentTarget).closest(".product-single");
                    "disabled" != t.find(".btn-product.btn-carts").attr("disabled") &&
                        Riode.Minipopup.open({
                            message: "Successfully Added",
                            productClass: "product-compare",
                        ...
                        s.length
                            ? document.body.classList.contains("home")
                                ...
                                : (Riode.$body.on("click", ".product-single .product-image-full", i),
                                  Riode.$body.on("click", ".single-product .btn-carts:not(.disabled)", e),
            ...
            (Riode.Shop = {
                ...
                initProductsCartAction: function () {
                    Riode.$body
                        ...
                        .on("click", ".product:not(.product-variable) .btn-product-icon.btn-carts, .product:not(.product-variable) .btn-product.btn-carts", function (e) {
                            e.preventDefault();
                            var t,
                                i,
